...
export function HeroSection() {
  ...
  return (
    <section className="page-section active pt-8 sm:pt-[max(60px,7.4dvh)]">
      <header className="relative w-full flex flex-col justify-center items-center overflow-hidden bg-cover bg-center h-[200px] sm:h-[380px]" style={{ backgroundImage: 'url(/herosection-v3.jpeg)' }}>
