        ...
        <div className="py-20 px-6 relative z-10">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="font-bold text-3xl text-green-800 mb-3">Kelas Online</h2>
              <p className="text-slate-500">Tingkatkan skill Anda dengan materi berkualitas dari para ahli industri hijau</p>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center relative z-10">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex gap-4 items-start p-5 bg-[#eaf8f0] rounded-xl">
                      <BookOpen className="w-6 h-6 text-[#1a8b44] mt-1 shrink-0" />
                      <div>
                        <p className="font-bold text-gray-900 text-sm">Materi Lengkap & Terstruktur</p>
                        <p className="text-gray-500 text-sm mt-1">Kurikulum disusun oleh ahli industri hijau dengan modul bertahap dari dasar hingga mahir.</p>
                      </div>
                    </div>
                    <div className="flex gap-4 items-start p-5 bg-yellow-50 rounded-xl">
                      <Zap className="w-6 h-6 text-yellow-600 mt-1 shrink-0" />
                      <div>
                        <p className="font-bold text-yellow-700 text-sm">Sertifikat & Poin Pembelajaran</p>
                        <p className="text-gray-500 text-sm mt-1">Dapatkan sertifikat kelulusan dan poin untuk setiap modul yang diselesaikan.</p>
                      </div>
                    </div>
                    <div className="flex gap-4 items-start p-5 bg-[#eaf8f0] rounded-xl">
                      <Award className="w-6 h-6 text-[#1a8b44] mt-1 shrink-0" />
                      <div>
                        <p className="font-bold text-[#1a8b44] text-sm">Interaktif & Menyenangkan</p>
                        <p className="text-gray-500 text-sm mt-1">Flashcard review, kuis evaluasi, dan progress tracking untuk pengalaman belajar terbaik.</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-16">
              {['Energi Terbarukan', 'Pengelolaan Limbah', 'Pertanian Berkelanjutan'].map((cat, catIdx) => (
                <div key={catIdx}>
                  <h3 className="text-2xl font-bold text-[#1a8b44] mb-8 flex items-center gap-3">
                    {cat === 'Energi Terbarukan' && <Zap className="w-6 h-6 text-[#1a8b44]" />}
                    {cat === 'Pengelolaan Limbah' && <RefreshCw className="w-6 h-6 text-[#1a8b44]" />}
                    {cat === 'Pertanian Berkelanjutan' && <Leaf className="w-6 h-6 text-[#1a8b44]" />}
                    {cat}
                  </h3>
                  <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {courseData.filter(c => c.category === cat).map((course) => (
                      <div key={course.id} className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow border border-gray-100 flex flex-col">
                        ...
                        <div className="p-6 flex flex-col flex-1">
                          ...
                          <button 
                            className="bg-[#1a8b44] hover:bg-green-800 text-white w-full py-2.5 rounded-lg text-sm font-bold transition"
                            onClick={() => {
